...
- Note: For any endpoint that token is required, pass the token generated by authentication service as the Authorization header `Authorization: Bearer <token>`
